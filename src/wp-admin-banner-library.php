...
class WP_Admin_Banner_Library {

    protected $script_version = '1.0.0';

    protected $key = 'xpeedstudio_banner';
    protected $data;
    ...
    public function show_banner(){
        ...
        foreach($this->data as $banner) {
            ...
            if($banner->start <= time() && time() <= $banner->end) {
                ...
                if($this->is_correct_screen_to_show($banner->screen, $screen->id) && class_exists('\Emranio\WP_Notice_Adapter')) {
                    ...
                    \Emranio\WP_Notice_Adapter::instance('wpmet-jhanda', $banner_unique_id)
